...
<p class="five">问卷5:<I>${requestScope.object.five}</I><font color="red">[修改]</font></p>
 ...
 <p> <input name="value" value="" type="text" autocomplete="off">
  ...
  <div id="footer">
  <p><a href="AdminServlet?action=update&phone=${requestScope.object.phone}&service=review&type=xunta&deal=pass">通 过</a></p>
  <p><a href="AdminServlet?action=update&phone=${requestScope.object.phone}&&service=review&type=xunta&deal=no_pass">拒 绝</a></p>
  </div>
  </div>
  </body>
</html>
