...
%>   
  ...
  <script src="javascript/userinformation/usershow.js"></script>
  <%
 ...
 <p><marquee>
 <a href="ForwardServlet?action=activities&type=xunta&page=datingteacher">&lt;&lt;&lt;"相逢不恨晚" 星乐趴·优活寻Ta 30后专场通道&gt;&gt;&gt;</a></marquee>
 </p>
 <div id="search">
...
<div id="titlelist">
<%@include file="/WEB-INF/main/usershow_select.jsp" %>
<div id="show_all"><a href="MyServlet?action=show&type=all">查看全部>>></a></div>
</div>
<div id="list">
