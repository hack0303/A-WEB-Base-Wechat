...
<script type="text/javascript" src="javascript/management/review/xunta/register/begin.js"></script>
</head>
  <body>
  <div id="top"></div>
  <div id="nav">
...
<div id="bottom">
<ul><li><p><a href="AdminServlet?action=showUserDetail&phone=${object.phone}&type=xunta&func=register&state=nopass">查看详情</a></p></li>
<li><p><a href="javascript:pass(${object.phone})">通过</a></p></li>
<li><p><a href="javascript:nopass(${object.phone})">拒绝</a></p></li>
</ul>
</div>
</div>
</c:forEach>
