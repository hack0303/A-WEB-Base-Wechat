...
<html style="height:100%;">
  ...
  <link rel="stylesheet" href="css/userinformation/Woyue/declare/four.css" type="text/css"></link>
  <script type="text/javascript" src="javascript/jquery.js"></script>
  <script type="text/javascript" src="javascript/userinformation/Woyue/declare/four.js"></script></head>
 ...
 <div class="title"><h1>印象评分</h1></div>
  ...
  <input type="hidden" name="type" value="woyue">
