...
<link rel="stylesheet" href="css/default.css" type="text/css"></link>
  <link rel="stylesheet" href="css/userinformation/register/ruiqu/two.css" type="text/css"></link>
<script type="text/javascript" src="javascript/jquery.js"></script>
  <script type="text/javascript" src="javascript/userinformation/register/ruiqu/two.js"></script></head>  
  <body>
  <div id="nav">
  <div id="title">
  <h1>
  ...
  <marquee>
  <p>如需要升级为双人卡需补充同伴信息
  if you want to upgrade your card
  to double card please fill in the
  form of your partner's information</p>
  </marquee>
  </h1>
  </div>
