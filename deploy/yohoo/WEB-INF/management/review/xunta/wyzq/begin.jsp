...
<link rel="stylesheet" href="css/management/xunta/wyzq.css" type="text/css"></link>
<script type="text/javascript" src="javascript/management/review/xunta/wyzq/begin.js"></script></head>
  <body>
  <div id="top"></div>
  <div id="nav">
...
<div id="bottom">
<ul><li><p><a href="AdminServlet?action=showUserDetail&phone=${object.phone}&type=xunta&func=wyzq&state=begin">查看详情</a></p></li>
<li style="">
<div id="title">鼠标悬浮此处进行修改</div>
<div id="change">
<p><input type="text" name="state">期</p>
<input type="hidden" name="phone" value="${object.phone}">
<input type="hidden" name="phone" value="${object.gender}">
<p id="submit">同 意</p>
</div>
</li>
