...
<script type="text/javascript" src="javascript/main/admin/xunta_register.js"></script>
...
<div id="bottom">
<ul><li><p><a href="AdminServlet?action=showUserDetail&phone=${object.phone}&type=xunta&from=register">查看详情</a></p></li>
